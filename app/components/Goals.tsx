...
export default function Goals() {
  ...
  return (
    <section ref={sectionRef} id="goals" className="py-8 md:py-12 bg-white">
      <div className="container mx-auto px-6">
        <h2 className="text-3xl md:text-5xl font-bold mb-8 text-center gradient-text mx-auto">Our Goals</h2>
